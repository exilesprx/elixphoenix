...
config :elixphoenix, ElixphoenixWeb.Endpoint,
  ...
  http: [ip: {0, 0, 0, 0}, port: System.get_env("APP_PORT") |> String.to_integer()],
  check_origin: false,
  code_reloader: true,
  debug_errors: true,
...
config :elixphoenix, ElixphoenixWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/elixphoenix_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :elixphoenix, dev_routes: true
